...
class FlipkartScapr:
    ...
    def get_top_reviews(self,product_url,count=2):
        ...
        try:
            ...
            for _ in range(4):
                ActionChains(driver).send_keys(Keys.END).perform() ## in most pressing end key will load more reviews which will be helpful to get more reviews
                time.sleep(1.5)
